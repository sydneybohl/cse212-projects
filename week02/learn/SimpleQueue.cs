public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: It was trying to remove data from index 1 rather than 0
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Defect - Need to add to the end of the queue
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // Defect 1 - Should be index 0 not 1
        _queue.RemoveAt(0);
        return value;
}} 